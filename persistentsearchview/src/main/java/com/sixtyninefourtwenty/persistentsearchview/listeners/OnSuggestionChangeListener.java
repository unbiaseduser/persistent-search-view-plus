...
package com.sixtyninefourtwenty.persistentsearchview.listeners;
...
public interface OnSuggestionChangeListener {
     ...
     */
    void onSuggestionPicked(Suggestion suggestion);
     ...
     * @param suggestion The suggestion item
     */
    void onSuggestionRemoved(Suggestion suggestion);
